...
export const NewReleasesIcon = ({ size, color, className }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      preserveAspectRatio="xMidYMid meet"
...
export const ChartsIcon = ({ size, color, className }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      preserveAspectRatio="xMidYMid meet"
...
export const MoodsAndGenresIcon = ({ size, color, className }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      preserveAspectRatio="xMidYMid meet"
...
export const PointIcon = ({ size, color, className }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      preserveAspectRatio="xMidYMid meet"
    ...
    >
      <g>
        <path
          d="M 15.5, 12 a3.5,3.5 0 1,1 0,-.00001"
          className="style-scope yt-icon"
        ></path>
      </g>
    </svg>
...
export const SeeAllIcon = ({ size, color, className }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      preserveAspectRatio="xMidYMid meet"
